...
RAW_BASE_URL="https://raw.githubusercontent.com/${SOURCE_REPO}/${BRANCH}/packages/apps"
...
source: https://github.com/${SOURCE_REPO}/blob/main/packages/apps/${app}/README.md
-->
