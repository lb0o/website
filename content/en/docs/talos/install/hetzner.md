...
Just follow the **Cozystack Tutorial** starting from the [**Bootstrap cluster**]({{% ref "/docs/getting-started/deploy-cluster#1-bootstrap-talos-cluster" %}}) section, to continue the installation.
